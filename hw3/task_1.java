...
import java.nio.file.StandardOpenOption;
   ...
   public class task_1 {
    ...
    // Если введена пустая строка, то выходим из цикла и будем завершщать программу.
    // Если введена строка, которая не соотвествует требованиям,
    // тогда будут вызваны соответсвующие исключения.
    ...
    // разделяет полученную строку и проверяет если делиться меньше чем на 4 слова,
